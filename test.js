<script>console.log("CONTAINER %cWNW5BT6%c BUILD 2019-11-07 12:52:53","color:#00661d; text-decoration:underline","color:#000");

var sec = Math.floor((new Date()).getTime() / 1000) - 1573131173;console.log(Math.floor(sec / 3600)+"h "+Math.floor((sec - Math.floor(sec / 3600)*3600) / 60)+"m");(function(w,d,p){
